window.DEFAULT_WORKOUTS_VERSION = 2026083101;
  ...
  workouts: [
    {
      ...
      exercises: [
        ...
        { id: 2, exerciseId: "agachamento-bosu", sets: 3, reps: "12", rest: 60, history: [] },
        { type: "rest", name: "Descanso", duration: 60 },
        { id: 3, exerciseId: "elevacao-y-polia", sets: 3, reps: "12", rest: 60, history: [] },
        { id: 4, exerciseId: "agachamento-sumo-halteres", sets: 3, reps: "12", rest: 60, history: [] },
        { type: "rest", name: "Descanso", duration: 60 },
        { id: 5, exerciseId: "crucifixo-inverso-halteres", sets: 3, reps: "12", rest: 60, history: [] },
        ...
        { id: 8, exerciseId: "agachamento-bulgaro-halteres", sets: 3, reps: "12", rest: 60, history: [] }
      ]
    },
    {
      id: "B",
    ...
    },
    {
      ...
      exercises: [
        ...
        { type: "rest", name: "Descanso", duration: 60 },
        { id: 17, exerciseId: "triceps-polia-corda", sets: 3, reps: "10", rest: 60, history: [] },
